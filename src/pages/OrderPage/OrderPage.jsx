...
import InputComponent from '../../components/InputComponent/InputComponents';
...
const OrderPage = () => {
  ...
  console.log('dissssssssssss', priceDiscountMemo)
  ...
  return (
    <div style={{ background: '#f5f5fa', with: '100%', height: '900px'}}>
      <div style={{height: '100%', width: '1270px', margin: '0 auto'}}>
        <h4 style={{margin:'10 auto',fontWeight: 'bold'}}>Trang chủ - Giỏ hàng</h4>
        <div style={{ display: 'flex', justifyContent: 'center'}}>
          ...
          <WrapperRight style={{marginTop:'55px'}}>
            <div style={{width: '100%'}}>
              <WrapperInfo>
                <div>
                  <span>Địa chỉ: </span>
